...
@Directive({
  selector: '[numberCommaSeparator]'
})
export class numberCommaSeparatorDirective {
...
formatValue()
{
  ...
  if (this.nativeEl.attributes.maxlength!=null&&this.nativeEl.attributes.maxlength.value){
